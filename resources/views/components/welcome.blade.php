<div
    class="p-6 lg:p-8 bg-surface-alt dark:bg-surface-dark-alt dark:from-gray-700/50 dark:via-transparent border-b border-gray-300 dark:border-gray-700">
...
<div
    class="bg-gray-200 dark:bg-surface-dark-alt bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
